...
public class Classify {
	...
	public Classify(double[][] groundSilence, double[][] groundSpeech){
		...
		meanSilences[0] = meanSilences[0] / 50.0;
		meanSilences[1] = meanSilences[1] / 50.0;
		meanSilences[2] = meanSilences[2] / 50.0;
		meanSpeeches[0] = meanSpeeches[0] / 50.0;
		meanSpeeches[1] = meanSpeeches[1] / 50.0;
		meanSpeeches[2] = meanSpeeches[2] / 50.0;
	...
	private double getStandardDev(double[] base, double median){
		double count = 0;
		for (int i = 0; i < base.length; i++){
			count += ((base[i] - median) * (base[i] - median));
		}
