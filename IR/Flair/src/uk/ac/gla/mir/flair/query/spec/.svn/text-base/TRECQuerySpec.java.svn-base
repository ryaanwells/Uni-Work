...
import uk.ac.gla.mir.flair.query.TRECQuery;
 ...
 * @version 1.0
 */
public class TRECQuerySpec extends Spec {

	/** The Terms of the Query **/
	private String terms;
	
	public TRECQuerySpec(TIntArrayList fieldIDs, String terms){
	...
	public Query createQuery(IndexSpec indexSpec) {
		final TRECQuery tq = new TRECQuery(this,indexSpec);
		return tq;
	}
